...
export function Textarea({ className, ...props }: TextareaProps) {
  return (
    <textarea
      className={twMerge(
        "flex min-h-[120px] w-full resize-y rounded-lg border px-3 py-2 shadow-sm outline-none",
        ...
        "dark:focus-visible:border-violet-500 dark:focus-visible:ring-violet-500/10",
        className
      )}
      {...props}
    />
